...
function LoadYoutubeVidOnPreviewClick(id,w ,h) {
    var code='<iframe id="frame-yt" src="https://www.youtube.com/embed/'+id+'" width="'+w+'" height="'+h+'" frameborder=0 allowfullscreen style="border:1px solid #ccc;" ></iframe>';
...
function optimizeYouTubeEmbeds() {    
    ...
    $('iframe').each(function(index,item) {
        ...
        if($(item).attr('src') && $(item).attr('src').match(/http(s)?:\/\/www\.youtube\.com/)) {
            ...
            var code='<div class="youtubevid" style="width:'+w+'px; height:'+h+'px; margin:0 0"><a href="#" id="skipser-youtubevid-'+id+'"><img data-width="800" data-height="600" id="skipser-youtubevid-'+id+'" src="http://i.ytimg.com/vi/'+id+'/hqdefault.jpg" />'+
                     '<div id="skipser-youtubevid-'+id+'" style="background: url(\'data:image/png;base64,\') no-repeat scroll 0 0 transparent;height: '+h+'px;width: '+w+'px; position:relative; margin-left:0; margin-top:0;z-index:3;top:-'+h+'px;background-position:center;"></div></a></div>';
...
$(document).ready(function(){
    //var el=$("[id^='skipser-youtubevid-']");
    var el="";
    var id="";
    $( ".youtubevid" ).click(function( event ) {
    event.preventDefault();
  		...
  		$.fancybox(el,{
            ...
            'width' : 800,
            'height' :600,
            'href': "https://www.youtube.com/v/"+id+"?autoplay=1&autohide=1&border=0&wmode=opaque&enablejsapi=1",
            'type': 'swf',
