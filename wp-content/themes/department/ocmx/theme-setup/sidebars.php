...
function add_widgetized_pages(){
	...
	foreach($get_widget_pages as $pages) :
		...
		register_sidebar(array("name" => $post->post_title." Slider", "id" => $post->post_name . "-slider", "description" => "Place all 'Home Page Widgets' here."));
		register_sidebar(array("name" => $post->post_title." Body", "id" => $post->post_name . "-body", "description" => "Place all 'Home Page Widgets' here.", "before_title" => '<h4 class="widgettitle">', "after_title" => '</h4><div class="content">', 'before_widget' => '<li id="%1$s" class="widget %2$s">', 'after_widget' => '</div></li>'));
		register_sidebar(array("name" => $post->post_title." - Side by side", "id" => $post->post_name . "-secondary", "description" => "Place the (Obox) Content Widget and (Obox) Testimonial widgets here and then set the (Obox) Content Widget to display either Posts or Portfolio items.", "before_title" => '<h4 class="widgettitle">', "after_title" => '</h4>', 'before_widget' => '<li id="%1$s" class="widget %2$s"><div class="content">', 'after_widget' => '</div></li>'));
